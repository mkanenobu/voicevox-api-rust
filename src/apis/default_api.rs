...
pub async fn add_user_dict_word_user_dict_word_post(configuration: &configuration::Configuration, surface: &str, pronunciation: &str, accent_type: i32, word_type: Option<WordTypes>, priority: Option<i32>) -> Result<String, Error<AddUserDictWordUserDictWordPostError>> {
    let local_var_configuration = configuration;
...
pub async fn import_user_dict_words_import_user_dict_post(configuration: &configuration::Configuration, r#override: bool, request_body: ::std::collections::HashMap<String, crate::models::UserDictWord>) -> Result<(), Error<ImportUserDictWordsImportUserDictPostError>> {
    let local_var_configuration = configuration;
...
pub async fn rewrite_user_dict_word_user_dict_word_word_uuid_put(configuration: &configuration::Configuration, word_uuid: &str, surface: &str, pronunciation: &str, accent_type: i32, word_type: Option<WordTypes>, priority: Option<i32>) -> Result<(), Error<RewriteUserDictWordUserDictWordWordUuidPutError>> {
    let local_var_configuration = configuration;
