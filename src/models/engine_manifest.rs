...
pub struct EngineManifest {
    ...
    #[serde(rename = "downloadable_libraries_path", skip_serializing_if = "Option::is_none")]
    pub downloadable_libraries_path: Option<String>,
    #[serde(rename = "downloadable_libraries_url", skip_serializing_if = "Option::is_none")]
    pub downloadable_libraries_url: Option<String>,
    #[serde(rename = "supported_features")]
    pub supported_features: Box<crate::models::>,
}

impl EngineManifest {
    /// エンジン自体に関する情報
    pub fn new(manifest_version: String, name: String, brand_name: String, uuid: String, url: String, icon: String, default_sampling_rate: i32, terms_of_service: String, update_infos: Vec<crate::models::UpdateInfo>, dependency_licenses: Vec<crate::models::LicenseInfo>, supported_features: crate::models::) -> EngineManifest {
        EngineManifest {
            manifest_version,
            name,
            brand_name,
            ...
            supported_features: Box::new(supported_features),
        }
    }
}
